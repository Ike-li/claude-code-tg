...
Security fixes are best effort and focus on the latest tagged release (`v0.8.2`)
and the current `main` branch.

| Version or branch | Security support |
| --- | --- |
| Latest tagged release (`v0.8.2`) | Best-effort fixes for issues affecting the latest release. |
